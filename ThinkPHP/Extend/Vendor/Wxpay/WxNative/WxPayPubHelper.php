...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
        ...
        //echo($String)."</br>";
		//签名步骤三：MD5加密
        //$String_temp="appid=wx75b76483f394e4cf&body=3dcity&mch_id=1251733301&nonce_str=ibuaiVcKdpRxkhJA&notify_url=http://www.3dcity.com/user.php/wxpay/notify_url&out_trade_no=1217752501201407033233368018&spbill_create_ip=192.168.40.176&total_fee=259&trade_type=APP&key=gdi2012e9c2e2bb619514ecea142e449";
        $String = md5($String);
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function postXml()
	{
	   // $xml = $this->createXml();
        $this->parameters["appid"] = WxPayConf_pub::APPID;//公众账号ID
        $this->parameters["mch_id"] = WxPayConf_pub::MCHID;//商户号
        $this->parameters["nonce_str"] = "ibuaiVcKdpRxkhJA";//随机字符串
        $this->parameters["sign"] = $this->getSign($this->parameters);//签名
    ...
    //print_r($this->response);
       // $this->response['sign_new']= $this->parameters["sign"];
	...
	function getResult(){
        ...
        $result=$this->result;
        $result['sign_new']=$this->parameters["sign"];
		return $result;
	}
}
