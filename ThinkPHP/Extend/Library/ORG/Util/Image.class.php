    ...
    static function thumb($image, $thumbname, $type='', $maxWidth=200, $maxHeight=50, $interlace=true) {
        ...
        if ($info !== false) {
            ...
            if('png'==$type){
                ...
                $background_color = imagecolorallocate($thumbImg, 255, 255, 255); // 指派一个白色
                imagefilledrectangle($thumbImg,0,0,$maxWidth,$maxHeight,$background_color);
            }elseif('gif'==$type){
    ...
    static function thumb2($image, $thumbname, $type='', $maxWidth=200, $maxHeight=50, $interlace=true) {
        ...
        if ($info !== false) {
            ...
            if ('gif' == $type || 'png' == $type) {
            	 //$background_color = imagecolorallocate($thumbImg, 255, 0, 0); // 指派一个绿色
            	 //imagecolortransparent($thumbImg, $background_color); // 设置为透明色，若注释掉该行则输出绿色的图
            }
