...
abstract class ThinkOauth{
     ...
     */
    public function getInstance($type, $token = null,$url) {
    	$this->Callback=$url;
	 ...
	 * 请求code 
	 */
	public function getRequestCodeURL($url){
		$this->config($url);
		//Oauth 标准参数
		$params = array(
	 ...
	 */
	public function getAccessToken($code, $extend = null,$url){
		//$this->config($url);
		$params = array(
				'client_id'     => $this->AppKey,
