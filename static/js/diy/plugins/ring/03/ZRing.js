...
ZRing.prototype = {
    generateRingGeometry : function (parameters) {
        ...
        if(parameters.heightUD === undefined) parameters.heightUD = 1.2;
        if(parameters.heightC === undefined) parameters.heightC = 2;
        ...
        for(var i=0; i<size; i++) {
            circle_pts.push(new THREE.Vector3(circle_radius * Math.cos(i * 2 * Math.PI / size), 0, circle_radius * Math.sin(i * 2 * Math.PI / size)));
        }
        ...
        var path = this.zShape.createTOCPath(parameters.upRadius, parameters.downRadius, parameters.width, parameters.heightUD, parameters.heightC);
    ...
    create : function(inputParameters, reDraw) {
        ...
        var ringGeometry = this.generateRingGeometry({
            width : _thickness, 
            heightUD : ring_height,
            heightC : text_height,
        ...
        wordGeometry.merge(ringGeometry);
...
// html中执行
function execute() {
    var textElement = document.getElementById("web3dRing03Textvalue");
    var textFontElement = document.getElementById("web3dRing03Textfont");
    var thicknessElement = document.getElementById("web3dRing03Thickness");
    var ringHeightElement = document.getElementById("web3dRing03RingHeight");
    var textHeightElement = document.getElementById("web3dRing03TextHeight");
    // var UAElement = document.getElementById("web3dRing03UA");
    // var DAElement = document.getElementById("web3dRing03DA");
    
    var sizeElement = document.getElementById("web3dRing03Size");
    ...
    var zRing = new ZRing(materialManage.material);
